...
> **Дисклеймер:** Этот проект написан в стиле *vibe coding* — чтобы изучить возможности ИИ-ассистента и одновременно собрать что-то реально полезное. Ждите шероховатостей.
...
**Включено из коробки** (любую ОС/дистрибутив можно добавить через `make add-new-os`):
